<?php
	...
	*/
	...
	function getThumbnailSpecs($tableName, $fieldName, $view){
		...
		elseif($tableName=='instructors' && $fieldName=='photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='instructors' && $fieldName=='photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		return FALSE;
	}
	########################################################################
	...
	function logOutUser(){
		...
		if(isset($_COOKIE['education_center_rememberMe'])){
			setcookie('education_center_rememberMe', '', time()-42000);
		}
		session_destroy();
	}
	########################################################################
